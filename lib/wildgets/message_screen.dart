...
import 'package:slicing/pages/message_detail_page.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      itemCount: usersRepostory.length,
                      separatorBuilder: (context, index) =>
                          const SizedBox(height: 15),
                      itemBuilder: (context, index) {
                        final user = usersRepostory[index];
                        return GestureDetector(
                          onTap: () async {
                            final result = Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (contex) => MessageDetailPage(),
                                settings: RouteSettings(arguments: user.id),
                              ),
                            );

                            print("Data need to refresh : ${await result}");
                          },
                          child: Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 10),
                            child: Row(
